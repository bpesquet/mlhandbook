...
Accuracy
  Evaluation metrix measuring the fraction of predictions that a classification model got right ([Wikipedia](https://en.wikipedia.org/wiki/Evaluation_of_binary_classifiers)).
